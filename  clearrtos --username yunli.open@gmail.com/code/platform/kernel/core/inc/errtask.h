...
enum {
    ...
    ERROR_TASK_DELETE_INVHANDLER,
    ERROR_TASK_START_INVHANDLER,
    ERROR_TASK_START_INVOP,
    ERROR_TASK_RESTART_INVHANDLER,
    ERROR_TASK_RESTART_INVOP,
    ERROR_TASK_SUSPEND_INVHANDLER,
    ERROR_TASK_SUSPEND_NOTSTARTED,
    ERROR_TASK_RESUME_INVHANDLER,
    ERROR_TASK_RESUME_NOTSUSPENDED,
    ERROR_TASK_SLEEP_INVCONTEXT,
    ERROR_TASK_STACK_INVHANDLER,
