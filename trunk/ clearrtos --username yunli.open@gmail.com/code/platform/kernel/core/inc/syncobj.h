...
typedef struct type_sync_object sync_object_t, *sync_object_handler_t;

typedef bool (*sync_point_enter_t) (sync_object_handler_t _handler);
typedef void (*sync_point_wait_t) (sync_object_handler_t _handler);
typedef bool (*sync_point_exit_t) (sync_object_handler_t _handler, error_t *_p_ecode);
typedef void (*sync_point_wake_t) (sync_object_handler_t _handler);
...
} sync_operation_t, *sync_operation_handler_t;
...
} sync_container_t, *sync_container_handler_t;

struct type_sync_object {
    dll_node_t node_;
    magic_number_t magic_number_;
    task_bitmap_t pending_bitmap_;
    sync_container_handler_t container_;
