...
enum {
    ...
    ERROR_QUEUE_DELETE_INVHANDLER,
    ERROR_QUEUE_SEND_INVHANDLER,
    ERROR_QUEUE_SEND_FULL,
    ERROR_QUEUE_RECV_INVHANDLER,
    ERROR_QUEUE_EMPTY_INVHANDLER,
    ERROR_QUEUE_FULL_INVHANDLER
};
